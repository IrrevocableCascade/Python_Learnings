...
def diagonal_product_top(the_grid):
	...
	while offset <= 16:
		start_position = 0
		while start_position <= 320:

			a = grid[start_position + offset]
			b = grid[start_position + 21 + offset]
			c = grid[start_position + 42 + offset]
			d = grid[start_position + 63 + offset]
...
def diagonal_product_bottom(the_grid):
	...
	while offset <= 16:
		...
		while start_position >= 0:
			...
			a = grid[start_position + offset]
			b = grid[start_position - 19 + offset]
			c = grid[start_position - 38 + offset]
			d = grid[start_position - 57 + offset]
